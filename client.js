const CLIENT = {
  ...
  ist: {
    ...
    metrics: [
      { label: "Reichweite gesamt", value: "16.926", sub: "Ø 46 / Tag" },
      { label: "Views gesamt", value: "17.456", sub: "Ø 48 / Tag" },
      { label: "Interaktionen", value: "267", sub: "Ø 0,7 / Tag" },
      { label: "Profilbesuche", value: "1.270", sub: "Ø 3,5 / Tag" },
      { label: "Neue Follower", value: "142", sub: "Ø 1,4 / Woche" }
    ],
    chart: {
      labels: ["Mär 25","Apr","Mai","Jun","Jul","Aug","Sep","Okt","Nov","Dez","Jän 26","Feb","Mär"],
      reach:  [3082, 6895, 2317, 349, 363, 173, 82, 289, 414, 1386, 535, 986, 55],
      views:  [0, 0, 0, 0, 0, 439, 1876, 1813, 2688, 4675, 2107, 3409, 449]
    },
    observations: [
      {
        type: "positive",
        label: "Was funktioniert",
        items: [
          "Video-Content (Reels) erzielt deutlich mehr Views und Interaktionen als statischer Content",
          "Dezember 2025: stärkster Monat mit 4.675 Views und 148 Interaktionen",
          "Engagement Rate von 1,6% ist für einen kleinen Account solide"
        ]
      },
      {
        type: "negative",
        label: "Was nicht funktioniert",
        items: [
          "Kontinuität fehlt — lange Pausen (Jun/Jul 2025 fast inaktiv)",
          "Nur 55 von 366 Tagen mit nennenswerter Reichweite (>50)",
          "Post-Level-Daten fehlen — keine Analyse welche Themen performen"
        ]
      },
      {
        type: "insight",
        ...
        items: [
          "Ab August 2025 wurden Views getrackt — das ist der Moment wo Video-Content begann",
          "Sofortiger Effekt: Interaktionen stiegen von 0 auf 8, 24, 49, 148",
          "Zeigt klar: Format entscheidet mehr als Frequenz"
        ]
      }
    ]
  },
